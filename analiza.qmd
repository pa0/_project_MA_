...
# 1 - n = n1 + n2, n1 != n2 
# 2 - n = n1, n2 = NA
# 3 - n != n1 + n2  -> w artykule nie ma wyjaśnienia czemu, więc lepiej przyjąć n1= n2 = n/2
# 4 - n1 = n2 = NA

# do przypadku 3
data = data %>%
  mutate(across(starts_with('n_'), ~ ifelse(str_sub(cite, 1, 24) == 'tountopoulou2021training', n/2, .x)))

# dla przypadków 0,1,3 
data = data %>%
...
# 1. sprawdzić co powinno być n w przypadkach 2 i 4
# 2. zmienić CI na beta na T i to na d, bo:
